    ...
    <main className="bg-base-100 text-base-content">
      ...
      <section className="min-h-screen flex flex-col items-center justify-center text-center px-6 pb-6">
        ...
        <div className="flex gap-4 mb-6">
          ...
          <a className="btn btn-outline" href="#get-started">Get Started</a>
        </div>
      </section>
      ...
      {/* Use Case Examples */}
      <section id="get-started" className="py-16 px-6 bg-base-200">
      ...
      {/* CTA Footer */}
      <footer className="py-10 text-center bg-base-200">
