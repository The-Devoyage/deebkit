...
The like operator in Deeb works similarly to SQL’s LIKE '%value%'. It performs a partial 
...
🧠 Learn more about how to use queries in context in the [Collection Trait Guide](/docs/collection-trait) or explore advanced scenarios in the [Programmatic Usage Guide](/docs/programmatic-usage).

📚 For full API reference, check out the [Deeb docs on docs.rs](https://docs.rs/deeb/latest/deeb/).
